<section class="equipe">
        ...
        <div class="divisao">
                ...
                <div class="mb-5 col-12 col-md-6 col-lg-2 text-center">
                    <img src="../imagens/integrantes/palloma.jpg" alt="Palloma, moça de cabelos médios pretos, óculos retangulares, roupa cinza em um fundo azul" class="adriel">
                    <h3 class=" mt-2 p-0 m-0">Palloma Hortencio</h3>
                    <button class="btn btn-equipe mt-2"><a href="https://linkr.bio/pallomahortencio" target="_blank" rel="external" alt="Link para perfil de Adriel">Veja mais</a></button> 
                </div>
