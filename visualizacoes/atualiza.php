        ...
        <form enctype="multipart/form-data" action="" method="post" id="form-inserir" name="form-inserir" class="needs-validation" novalidate>
          <div class="row g-3 mx-auto">
            <div class="col-sm-12 col-md-6 col-lg-4" >
              ...
              <input type="text" class="form-control" id="firstName" name="titulo" placeholder="" value="<?= $livro['titulo']?>" required> 
            </div>

            <div class="col-sm-12 col-md-6 col-lg-4">
              <label for="autor" class="form-label title">Autor</label>
              <input type="text" class="form-control" id="autor" placeholder="" name="autor" value="<?= $livro['autor']?>" required>
            </div>

            <div class="col-sm-12 col-md-6 col-lg-4">
              <label for="autor" class="form-label title">Descrição</label>
              <input type="text" class="form-control" id="descricao" placeholder="" name="descricao" value="<?= $livro['descricao']?>" required>
            </div>
            ...
            <div class="col-md-6 col-lg-4">
              ...
              <?php
                    if ($livro['dias']) {
                   ?>
                   <option value="<?= $livro['dias']?>" selected> <?= $livro['dias']?> </option>
                   <?php
                }
                ?>
            ...
            <div class="col-md-6 col-lg-4">
              ...
              <?php
                    if ($livro['horarios']) {
                   ?>
                   <option value="<?= $livro['horarios']?>" selected> <?= $livro['horarios']?> </option>
                   <?php
                }
                ?>
